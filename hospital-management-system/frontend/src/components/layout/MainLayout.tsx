  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Copay Refunds', href: '/copay-refunds', icon: ArrowUturnLeftIcon, color: 'from-amber-500 to-orange-600',
        permission: 'billing:read',
        roles: ['SUPER_ADMIN', 'HOSPITAL_ADMIN', 'ACCOUNTANT', 'RECEPTIONIST'] },
      { name: 'Copay Verification', href: '/copay-verification', icon: ClipboardDocumentCheckIcon, color: 'from-teal-500 to-emerald-600',
        permission: 'billing:read',
        roles: ['SUPER_ADMIN', 'HOSPITAL_ADMIN', 'ACCOUNTANT', 'RECEPTIONIST'] },
      { name: 'Copay Reconciliation', href: '/billing/copay-reconciliation', icon: DocumentChartBarIcon, color: 'from-cyan-500 to-blue-600',
        permission: 'billing:reports',
        roles: ['SUPER_ADMIN', 'HOSPITAL_ADMIN', 'ACCOUNTANT'] },
