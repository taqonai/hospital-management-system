  ...
  return (
    <Menu as="div" className="relative">
      {({ open }) => {
        ...
        return (
          <>
            <Menu.Button className="relative p-2.5 rounded-xl text-gray-500 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
              {unreadCount > 0 ? (
            ...
            >
              <Menu.Items className="absolute right-0 mt-2 w-96 origin-top-right rounded-2xl bg-white shadow-xl ring-1 ring-black/5 focus:outline-none overflow-hidden z-50">
                ...
                <div className="border-t border-gray-100 p-2">
                  <Link
                    to="/notifications"
                    className="block w-full px-4 py-2 text-center text-sm font-medium text-blue-600 hover:bg-blue-50 rounded-xl transition-colors"
                  >
