      ...
      >
        <View style={styles.recordHeader}>
          <View style={[styles.recordIcon, { backgroundColor: `${recordColor}15` }]}>
            <Ionicons name={getRecordIcon(item.type || '')} size={24} color={recordColor} />
          </View>
          ...
          <Ionicons name={isExpanded ? 'chevron-up' : 'chevron-down'} size={20} color={colors.gray[400]} />
        </View>
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>
              {searchQuery ? 'Try adjusting your search or filters' : 'Your medical records will appear here'}
            </Text>
          </View>
        }
        refreshControl={
          <RefreshControl refreshing={isRefreshing} onRefresh={handleRefresh} colors={[colors.primary[600]]} />
        }
      />
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  searchContainer: {
    ...
    margin: spacing.lg, marginBottom: spacing.md, paddingHorizontal: spacing.md,
    borderRadius: borderRadius.md, borderWidth: 1, borderColor: colors.border,
  },
  searchInput: { flex: 1, paddingVertical: spacing.md, paddingHorizontal: spacing.sm, fontSize: typography.fontSize.base, color: colors.text.primary },
  filterContainer: { backgroundColor: colors.white, borderBottomWidth: 1, borderBottomColor: colors.border },
  filterList: { paddingHorizontal: spacing.lg, paddingVertical: spacing.sm },
  filterTab: { paddingHorizontal: spacing.lg, paddingVertical: spacing.sm, marginRight: spacing.sm, borderRadius: borderRadius.full, backgroundColor: colors.gray[100] },
  filterTabActive: { backgroundColor: colors.primary[600] },
  filterTabText: { fontSize: typography.fontSize.sm, fontWeight: typography.fontWeight.medium as any, color: colors.text.secondary },
  filterTabTextActive: { color: colors.white },
  countContainer: { paddingHorizontal: spacing.lg, paddingVertical: spacing.sm },
  countText: { fontSize: typography.fontSize.sm, color: colors.text.secondary },
  listContent: { padding: spacing.lg, paddingTop: spacing.sm },
  recordCard: { backgroundColor: colors.white, borderRadius: borderRadius.lg, padding: spacing.lg, marginBottom: spacing.md, ...shadows.sm },
  recordHeader: { flexDirection: 'row', alignItems: 'center' },
  recordIcon: { width: 48, height: 48, borderRadius: 24, justifyContent: 'center', alignItems: 'center', marginRight: spacing.md },
  recordInfo: { flex: 1 },
  recordType: { fontSize: typography.fontSize.base, fontWeight: typography.fontWeight.semibold as any, color: colors.text.primary, textTransform: 'capitalize' },
  recordDate: { fontSize: typography.fontSize.sm, color: colors.text.secondary, marginTop: 2 },
  diagnosisContainer: { marginTop: spacing.md, paddingTop: spacing.md, borderTopWidth: 1, borderTopColor: colors.gray[100] },
  diagnosisLabel: { fontSize: typography.fontSize.sm, fontWeight: typography.fontWeight.medium as any, color: colors.text.secondary, marginBottom: spacing.xs },
  diagnosisText: { fontSize: typography.fontSize.base, color: colors.text.primary, lineHeight: 22 },
  doctorRow: { flexDirection: 'row', alignItems: 'center', marginTop: spacing.md, flexWrap: 'wrap' },
  doctorText: { fontSize: typography.fontSize.sm, color: colors.text.secondary, marginLeft: spacing.xs },
  dotSeparator: { fontSize: typography.fontSize.sm, color: colors.gray[300], marginHorizontal: spacing.sm },
  departmentText: { fontSize: typography.fontSize.sm, color: colors.text.secondary },
  expandedContent: { marginTop: spacing.md, paddingTop: spacing.md, borderTopWidth: 1, borderTopColor: colors.gray[100] },
  detailSection: { marginBottom: spacing.md },
  detailLabel: { fontSize: typography.fontSize.sm, fontWeight: typography.fontWeight.medium as any, color: colors.text.secondary, marginBottom: spacing.xs },
  detailText: { fontSize: typography.fontSize.sm, color: colors.text.primary, lineHeight: 20 },
  attachmentsSection: { marginTop: spacing.sm },
  attachmentItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.gray[50], borderRadius: borderRadius.md, padding: spacing.md, marginTop: spacing.sm, gap: spacing.sm },
  attachmentText: { flex: 1, fontSize: typography.fontSize.sm, color: colors.primary[600] },
  emptyState: { flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: spacing['3xl'] },
  ...
  emptyText: { fontSize: typography.fontSize.base, color: colors.text.secondary, marginTop: spacing.sm, textAlign: 'center' },
});
